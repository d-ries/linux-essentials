...
In Windows we have several options to install software. We usually use installers that we find on disks and websites or even the Windows app store where we can find software in an online catalog. 
